...
# TODO: estrucutrando las instrucciones ddl, qudaria pendiente el dml y el dcl
def p_statement(t):
    '''statement        : create
                        | show 
                        | alter 
...
def create():
    '''create   : CREATE orreplce   DATABASE    ifnotexist NAME
    '''
    #TODO: crear un objeto para la representacion semantica
